...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'spCoder_CMP_011_2')
	DROP PROCEDURE spCoder_CMP_011_2
GO

--spCoder_CMP_011_2 'AZ_WhoDrugB2'

CREATE PROCEDURE dbo.spCoder_CMP_011_2
(  
