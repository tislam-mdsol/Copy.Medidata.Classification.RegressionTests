...
AS
	...
	BEGIN
		...
		INSERT INTO Roles
		(Active, RoleName, ModuleId, SegmentID, Deleted)
		VALUES(1, @RoleName, @ModuleID, @SegmentID, 0)
	...
	(RoleID, GroupID, ModuleActionId, SegmentID, Deleted)
	SELECT @RoleID, 1, MA.ModuleActionId, @SegmentID, 0
	...
	BEGIN
		...
		(GrantOnObjectId, GrantToObjectId, Active, RoleID, SegmentID, Deleted, DenyObjectRole)
		VALUES(@SegmentID, @UserID, 1, @RoleID, @SegmentID, 0, 0) 
