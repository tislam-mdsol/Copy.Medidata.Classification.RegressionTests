...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'spSegmentedGroupCodingPatternSearchKorean')
	DROP PROCEDURE dbo.spSegmentedGroupCodingPatternSearchKorean
GO
CREATE PROCEDURE [dbo].spSegmentedGroupCodingPatternSearchKorean
(	
	@synonymListId INT,
	@statusId INT,
