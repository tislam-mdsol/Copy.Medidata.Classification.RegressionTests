...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'spSegmentedGroupCodingPatternSearchJapanese')
	DROP PROCEDURE dbo.spSegmentedGroupCodingPatternSearchJapanese
GO
CREATE PROCEDURE [dbo].spSegmentedGroupCodingPatternSearchJapanese
(	
	@synonymListId INT,
	@statusId INT,
