...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			-- Create Task
			INSERT INTO CodingElements (SegmentId, CodingElementGroupID, CodingSourceAlgorithmId, StudyDictionaryVersionId, MedicalDictionaryLevelKey, VerbatimTerm, SourceSystemId, CodingRequestId, SourceIdentifier, WorkflowStateID, Priority, SourceField, SourceForm, SourceSubject, IsInvalidTask, IsClosed, UUID, CodingContextURI, UpdatedTimeStamp, MarkingGroup, BatchOID)
			VALUES (@SegmentId, @matchedGroupID, @CodingSourceAlgorithmId, @StudyDictionaryVersionId, @MedicalDictionaryLevelKey, @Term, @SourceSystemId, @CodingRequestId, @SourceIdentifier, @StartingWorkflowStateId, @Priority, @fieldRef, @formRef, @subjectRef, @isInvalid, @isClosed,@UUID, @CodingContextURI, @UpdatedTimeStamp, @MarkingGroup,@BatchOID)
