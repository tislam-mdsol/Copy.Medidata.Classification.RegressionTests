...
(
 ...
 @CommaDelimitedReferenceIDs NVARCHAR(MAX) = NULL
)
AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN TRY
		...
		INSERT INTO @ReferenceIDs (ReferenceID)  
			...
			FROM dbo.fnParseDelimitedString(ISNULL(@CommaDelimitedReferenceIDs, '0'), ',')
		...
		JOIN @ReferenceIDs R on lt.ReferenceID = R.ReferenceID OR 0 = R.ReferenceID
		...
		@TaskLog NVARCHAR(1000) = 'Task force completed by CMP',
