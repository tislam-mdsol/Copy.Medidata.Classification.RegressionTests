...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'spSegmentedGroupCodingPatternSearchChinese')
	DROP PROCEDURE dbo.spSegmentedGroupCodingPatternSearchChinese
GO
CREATE PROCEDURE [dbo].spSegmentedGroupCodingPatternSearchChinese
(	
	@synonymListId INT,
	@statusId INT,
