...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			-- Create Task
			INSERT INTO CodingElements (SegmentId, CodingElementGroupID, CodingSourceAlgorithmId, StudyDictionaryVersionId, DictionaryLevelId, VerbatimTerm, SourceSystemId, CodingRequestId, SearchType, SourceIdentifier, WorkflowStateID, Priority, SourceField, SourceForm, SourceSubject, IsInvalidTask, IsClosed, UUID, CodingContextURI, UpdatedTimeStamp, MarkingGroup, BatchOID)
			VALUES (@SegmentId, @matchedGroupID, @CodingSourceAlgorithmId, @StudyDictionaryVersionId, @DictionaryLevelId, @Term, @SourceSystemId, @CodingRequestId, @TermSearchType, @SourceIdentifier, @StartingWorkflowStateId, @Priority, @fieldRef, @formRef, @subjectRef, @isInvalid, @isClosed,@UUID, @CodingContextURI, @UpdatedTimeStamp, @MarkingGroup,@BatchOID)
