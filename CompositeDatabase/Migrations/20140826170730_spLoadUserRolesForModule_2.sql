...
BEGIN    
	...
	WHERE UOR.Active = 1 
		...
		AND @UserId IN (-1, UOR.GrantToObjectId) -- limit to given userId or ALL if 0
		AND @SecuredObjectId IN (-1, UOR.GrantOnObjectId) -- limit to given secured Id or ALL if 0
