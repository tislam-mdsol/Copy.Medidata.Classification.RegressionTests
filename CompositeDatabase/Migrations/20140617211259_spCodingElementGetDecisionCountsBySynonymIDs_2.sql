...
AS
	...
	SELECT 
		@completedCount = ISNULL(SUM(CASE WHEN CE.WorkflowStateID = @terminalStateID THEN 1 ELSE 0 END), 0),
		@inProcessCount = ISNULL(SUM(CASE WHEN CE.WorkflowStateID <> @terminalStateID THEN 1 ELSE 0 END), 0)
