IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'spSegmentedGroupCodingPatternUpdate')
	DROP PROCEDURE spSegmentedGroupCodingPatternUpdate
GO

CREATE PROCEDURE dbo.spSegmentedGroupCodingPatternUpdate 
(
