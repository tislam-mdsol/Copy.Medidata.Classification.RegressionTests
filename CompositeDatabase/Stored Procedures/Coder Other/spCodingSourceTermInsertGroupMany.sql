...
BEGIN
	...
	DECLARE @matchingCodingElementID BIGINT, 
		...
		@siteRef NVARCHAR(256),
		@lineRef NVARCHAR(256),
		@eventRef NVARCHAR(256),
	...
	BEGIN TRY
		...
		BEGIN
			...
			-- Create Task
			INSERT INTO CodingElements (SegmentId, CodingElementGroupID, CodingSourceAlgorithmId, StudyDictionaryVersionId, MedicalDictionaryLevelKey, 
				VerbatimTerm, SourceSystemId, CodingRequestId, SourceIdentifier, WorkflowStateID, Priority, SourceField, SourceForm, 
				SourceSubject, SourceSite, SourceLine, SourceEvent, IsInvalidTask, IsClosed, UUID, CodingContextURI, UpdatedTimeStamp, MarkingGroup, BatchOID,
				EdcDataId)
			VALUES (@SegmentId, @matchedGroupID, @CodingSourceAlgorithmId, @StudyDictionaryVersionId, @MedicalDictionaryLevelKey, 
				@Term, @SourceSystemId, @CodingRequestId, @SourceIdentifier, @StartingWorkflowStateId, @Priority, @fieldRef, @formRef, 
				@subjectRef, @siteRef, @lineRef,@eventRef,@isInvalid, @isClosed,@UUID, @CodingContextURI, @UpdatedTimeStamp, @MarkingGroup,@BatchOID,
				@EdcDataId)
			...
			INSERT INTO CodingSourceTermSupplementals (CodingSourceTermID, SupplementTermKey, SupplementalValue, Ordinal, SegmentId, IsComponent)
			SELECT @CodingElementID, TextKey, RawInputString, Ordinal, @SegmentId,
