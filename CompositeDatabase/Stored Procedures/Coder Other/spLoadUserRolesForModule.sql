...
BEGIN    
	...
	WHERE UOR.Active = 1 
		...
		AND @UserId IN (-1, UOR.GrantToObjectId) -- limit to given userId or ALL if -1
		AND @SecuredObjectKey IN ('-1', UOR.GrantOnObjectKey) -- limit to given secured Id or ALL if -1
