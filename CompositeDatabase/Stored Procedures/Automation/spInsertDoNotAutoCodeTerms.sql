...
BEGIN
	...
	(Term,Active,UserId,SegmentId,Created,Updated,MedicalDictionaryLevelKey,ListId)
	VALUES(@Term,1,@UserId,@SegmentId,GETDATE(),GETDATE(),@MedicalDictionaryLevelKey,@ListId)
END
