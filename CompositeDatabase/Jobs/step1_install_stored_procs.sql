    ...
    BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          SET @CurrentCommand07 = @CurrentCommand07 + 'IF EXISTS(SELECT * FROM ' + QUOTENAME(@CurrentDatabaseName) + '.sys.indexes indexes WHERE indexes.[object_id] = @ParamObjectID  AND indexes.is_disabled = 0 AND [type] = 6) BEGIN SET @ParamIsColumnStore = 1 END'
