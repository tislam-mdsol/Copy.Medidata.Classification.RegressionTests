...
AS
    ( SELECT    E.* ,
      ...
      FROM      dbo.CodingJobErrors E
	            JOIN dbo.CodingRequestCsvData CSV ON CSV.CodingRequestId = E.CodingRequestId
                JOIN dbo.CodingRequests R ON E.CodingRequestId = R.CodingRequestId
    )
GO
