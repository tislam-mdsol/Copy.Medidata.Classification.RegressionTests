...
{
    internal sealed class RaveSitePage
    {
        private readonly BrowserSession _Session;

        internal RaveSitePage(BrowserSession session)
        {
        ...
        private SessionElementScope GetSubjectSearchLabel()
        {
            var subjectsearchLabel = _Session.FindSessionElementById("_ctl0_Content_ListDisplayNavigation_lblFind");

            return subjectsearchLabel;
        }
        ...
        internal bool IsSitePageLoaded()
        {
            bool searchLabelExists = GetSubjectSearchLabel().Exists(Config.ExistsOptions);
            ...
            bool pageIsLoaded = GetSubjectSearchLabel().Text.Equals("Subject");
