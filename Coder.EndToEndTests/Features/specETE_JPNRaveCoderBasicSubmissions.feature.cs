...
#line 109
 testRunner.And("Coder App Segment is loaded", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 110
    testRunner.And("task \"ひどい頭痛\" is coded to term \"片側頭痛\" at search level \"Preferred Term\" with code \"" +
...
#line 139
 testRunner.Then("the coding decision on form \"ETE2\" for field \"Coding Field\" with row text \"ALPHA\"" +
                    " for verbatim \"terrible head pain\" contains the following data", ((string)(null)), table17, "Then ");
#line hidden
...
#line 149
 testRunner.Then("the coding decision on form \"ETE2\" for field \"Coding Field\" with row text \"BRAVO\"" +
                    " for verbatim \"terrible head pain\" contains the following data", ((string)(null)), table19, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
